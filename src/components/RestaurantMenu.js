...
const RestaurantMenu = () =>{
    ...
    return(
        <div className="w-1/2 p-4 mx-auto text-center border rounded-md bg-neutral-800">
            <h1 className="text-center text-4xl  m-auto font-extrabold pb-11">{name}</h1>
            <img src={CDN_LOGO_URL+cloudinaryImageId} className=" inset-0 w-100 h-100 mx-auto my-auto rounded-xl  " />
